      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-2">
              ...
              >
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <span className="text-2xl font-bold">{config.brandName || 'EcoTech'}</span>
                </div>
                <p className="text-slate-300 mb-6 leading-relaxed">
                  We're committed to providing sustainable, high-quality products that make a positive impact on our planet and your daily life.
                </p>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3 text-slate-300">
                    ...
                    <span>hello@{config.brandName?.toLowerCase() || 'ecotech'}.com</span>
                  </div>
                  <div className="flex items-center space-x-3 text-slate-300">
        ...
        <div className="border-t border-slate-800 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            >
              © {new Date().getFullYear()} {config.brandName || 'EcoTech'}. All rights reserved.
            </motion.div>
