...
const EcommerceTemplate: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        <div className={`w-full mx-auto px-4 sm:px-6 lg:px-8 ${containerWidth}`}>
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              {[
                ...
                <a
                  key={item.name}
                  href={item.href}
                  className="text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200 font-medium text-sm"
                  style={{ 
            ...
            <div className="flex items-center space-x-4">
              <button className="hidden sm:block text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 transition-colors duration-200 font-medium text-sm">
                Sign In
              </button>
              <button 
      ...
      <main className={isPreviewMode ? "pt-0" : "pt-16 lg:pt-20"}>
        ...
        {/* Benefits Section */}
        <section id="benefits" className={`w-full ${sectionSpacing}`}>
          <Benefits config={mergedConfig} />
        </section>
        ...
        {/* Reviews Section */}
        <section id="reviews" className={`w-full ${sectionSpacing}`}>
